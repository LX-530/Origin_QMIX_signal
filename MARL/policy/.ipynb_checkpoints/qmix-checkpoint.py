...
class QMIX:
    ...
    def deep_copy(self):
        ...
        new_agent.eval_rnn.load_state_dict(self.eval_rnn.state_dict())
        new_agent.eval_qmix_net.load_state_dict(self.eval_qmix_net.state_dict())
        # new_agent.target_rnn.load_state_dict(copy.deepcopy(self.target_rnn.state_dict()))
        # new_agent.target_qmix_net.load_state_dict(copy.deepcopy(self.target_qmix_net.state_dict()))
        # new_agent.optimizer.load_state_dict(copy.deepcopy(self.optimizer.state_dict()))
        new_agent.eval_hidden = None if self.eval_hidden == None else self.eval_hidden.clone().detach()
        # new_agent.target_hidden =copy.deepcopy(self.target_hidden)
        return new_agent
    ...
    def get_q_values(self, batch, max_episode_len):
        ...
        #     print(len(q_evals))
        # except RuntimeError:
        #     print(q_evals, batch, max_episode_len)
        #     assert False
