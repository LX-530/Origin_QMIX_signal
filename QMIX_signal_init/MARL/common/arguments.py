...
def get_common_args():
    ...
    parser.add_argument('--result_dir', type=str, default='/home/dell/桌面/signal_RL/signal_fire5.7/result', help='model directory of the policy')
    parser.add_argument('--load_model_dir', type=str, default='/home/dell/桌面/signal_RL/signal_fire5.7/MARL/model', help='result directory of the policy')
